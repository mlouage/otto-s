    ...
    <div className="sticky top-0 z-50 pl-8 pr-8 h-16 flex justify-end items-center bg-secondary text-white font-bold text-xs tracking-widest shadow-lg">
        <div>
            <ul className="h-full flex justify-between items-center">
                <li className="mr-2">
                    <Link to="https://www.facebook.com/ftottos/" className="flex items-center bg-black p-2 border border-primary">
                        <span>
                ...
                <li>
                    <Link to="https://www.instagram.com/ftottos/" className="flex items-center bg-black p-2 border border-primary">
                        <span>
