...
const SocialHeader = () => (
    <div className="pl-8 pr-8 h-16 flex justify-between items-center bg-gray-900 text-white font-bold">
        <div className="flex items-center">
            <span className="pr-4 uppercase text-green-600 font-bold">Vragen</span>
