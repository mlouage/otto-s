...
const SocialHeader = () => (
    <div className="sticky top-0 z-50 pl-8 pr-8 h-16 flex justify-between items-center bg-gray-900 text-white font-bold text-xs tracking-widest">
        <div className="flex items-center">
            <span className="pr-4 uppercase text-primary font-bold text-base hidden md:inline">Vragen</span>
            <div className="flex items-center bg-black p-2 border border-primary">
                <span>
                ...
                <span className="pl-2 hidden md:inline">
                    +32 473 22 45 23
                </span>
            </div>
        </div>
